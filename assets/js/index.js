...
const lyrics = await (await fetch(`${location.origin}/assets/lyrics/mamanresing.lrc`)).text();
...
audio.addEventListener('ended', function() {
  ...
  document.querySelector('.lyrics p').innerText = '';
  return audioPlayer.querySelector('#musictoggler').click();
});
